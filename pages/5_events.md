...
<script>
    ...
    while(j < table.rows.length ){
	      ...
	      $('#'+table_handle).append("<tr onclick='onclick='javascript:document.location.href('"+urll+"');''><td><b>"+spkr+"</b><span class='affil'> ["+aff+"] </span><span class='event_date'>"+day+" "+mon+", "+year+"</span><br><i>"+ttl+"</i><br><div id='abstractbox'>"+con+"</div></td></tr>");
	      j += 1;
	  }
